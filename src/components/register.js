...
import verifyEmail from "./../assets/email_sent.jpg";
				...
				<div className={styles.registerStyle.wrapperRight}>
					...
					{!emailview ? (
						...
						<div className={styles.registerStyle.wrapperRightContent}>
							...
							<span className={styles.registerStyle.verifyEmail}>
								We have send an email to verify, Please Verify and then Login
							</span>
						</div>
					)}
				</div>
